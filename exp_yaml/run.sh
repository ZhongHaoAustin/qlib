...
# cd $ROLLING_DIR && python rolling_benchmark.py --conf_path=$QLIB_YAML_DIR//home/zhonghao/code/qlib/exp_yaml/workflow_config_mlp_Alpha158.yaml run > $QLIB_EXP_LOG/rolling_mlp.log 2>&1
